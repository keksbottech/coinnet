...
const CurrencyBottomDrawer = () => {
  ...
  const [selectedCurrency, setSelectedCurrency] = useState( { id: 3, name: 'Ghanian Cedis', symbol: 'GHS', imageUrl: `https://flagsapi.com/GH/shiny/64.png`, balance: fiatWalletBalance?.balance?.GHS  });
