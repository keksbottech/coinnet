...
const TransactionAuthenticationCode = () => {  
  ...
  const navigateToTransactionComplete = () => {
      router.navigate('(trade)/transactioncomplete')
  }
  return (
    ...
    <View className='h-full'>
        ...
        <Text className='text-gray-500 text-xl' style={{marginVertical:20, width:300}}>Enter the 7-digit code we just texted to your phone number to verify your transaction</Text>
        <View>
...
<View style={{ flex:1, position:'absolute', width:'100%', bottom:10}}>
      <Button styles={{position:'relative'}} onClick={navigateToTransactionComplete} label='Continue'/>
